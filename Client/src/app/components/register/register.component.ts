    ...
    <div class="min-h-screen flex items-center justify-center bg-gray-900 relative overflow-hidden">
      ...
      <div class="relative z-10 bg-gray-800/50 backdrop-blur-xl border border-gray-700 p-8 rounded-2xl shadow-2xl w-full max-w-md">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-400 mt-2">Join FlowBase to manage tasks efficiently</p>
        </div>
        ...
        <div class="space-y-6">
            <div>
                ...
                <div class="relative">
                    ...
                    <input [(ngModel)]="username" type="text" class="w-full pl-10 pr-4 py-3 bg-gray-900/50 border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#0f4c5c] focus:border-transparent transition-all" placeholder="Choose a username">
                </div>
            </div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input [(ngModel)]="password" type="password" class="w-full pl-10 pr-4 py-3 bg-gray-900/50 border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#0f4c5c] focus:border-transparent transition-all" placeholder="Create a password">
                </div>
            </div>

            <button (click)="onRegister()" class="w-full bg-gradient-to-r from-[#0f4c5c] to-[#166070] hover:from-[#0c3b47] hover:to-[#12505c] text-white font-bold py-3 px-4 rounded-xl shadow-lg transform transition-all active:scale-95 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#0f4c5c] focus:ring-offset-gray-900">
                Sign Up
            </button>
        </div>
        ...
        <p class="mt-8 text-center text-sm text-gray-400">
            ...
            <a routerLink="/login" class="text-[#26a0b8] hover:text-white font-medium transition-colors cursor-pointer">Sign In</a>
        </p>
      </div>
    </div>
  `
